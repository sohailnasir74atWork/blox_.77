...
const bannerAdUnitId = getAdUnitId('native');
  ...
  return (
    <View style={styles.adContainermain}>
      <NativeAdView nativeAd={nativeAd} style={styles.adContainer}>
        <Image
          source={{ uri: nativeAd.icon?.url || "https://bloxfruitscalc.com/wp-content/uploads/2024/09/Blade_Icon.webp" }}
          style={styles.adIcon}
          resizeMode="contain"
        />
        ...
        <View style={styles.adContent}>
          ...
          <Text style={styles.adHeadline}>{nativeAd.headline || 'Sponsored Ad'}</Text>
          ...
          {nativeAd.starRating && nativeAd.starRating > 0 && (
            <Text style={styles.adStarRating}>
              <Text>⭐</Text> {nativeAd.starRating}/5
            </Text>
          )}

          {nativeAd.callToAction ? (
            <TouchableOpacity style={styles.adButton}>
              <Text style={styles.adButtonText}>{nativeAd.callToAction}</Text>
            </TouchableOpacity>
          ) : null}
        </View>
      </NativeAdView>
